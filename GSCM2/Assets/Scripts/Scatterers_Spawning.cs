...
public class Scatterers_Spawning : MonoBehaviour
{
    ...
    void Start()
    {
        v_shift = new Vector3(2.3f, 0.0f, -1.81f);
        ...
        Debug.Log("1" + mat_spheres[0].name);
        Debug.Log("2" + mat_spheres[1].name);
        Debug.Log("3" + mat_spheres[2].name);
        Debug.Log("4" + mat_spheres[3].name);
        Debug.Log("5" + mat_spheres[4].name);
                    ...
                    if (k > -1)
                    {
                        ...
                        if (num_MPC1 != 0)
                        {
                            ...
                            */
                            ...
                            for (int i = 0; i < num_MPC1; i++)
                            {
                                ...
                                var init_mat = mat_spheres[4].GetComponent<Renderer>();
                                capsuleRenderer.material = init_mat.material;
                        ...
                        if (num_MPC2 != 0)
                        {
                            ...
                            for (int i = 0; i < num_MPC2; i++)
                            {
                                ...
                                var init_mat = mat_spheres[3].GetComponent<Renderer>();
                                capsuleRenderer2.material = init_mat.material;
                                //capsuleRenderer2.material.SetColor("_Color", Color.red);
                                capsule2.transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                        ...
                        if (num_MPC3 != 0)
                        {
                            ...
                            for (int i = 0; i < num_MPC3; i++)
                            {
                                ...
                                var init_mat = mat_spheres[1].GetComponent<Renderer>();
                                capsuleRenderer3.material = init_mat.material;
                                //capsuleRenderer3.material.SetColor("_Color", Color.yellow);
                                capsule3.transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                        ...
                        if (num_DMC != 0)
                        {
                            ...
                            for (int i = 0; i < num_DMC; i++)
                            {
                                ...
                                capsuleRendererD.material = init_mat.material;
                                //capsuleRendererD.material.SetColor("_Color", Color.grey);
                                capsuleD.transform.localScale = new Vector3(0.3f, 0.3f, 0.3f);
